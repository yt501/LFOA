...
<head>
    ...
    <script src="${V_PATH}/assets/authority/js/Bootstrap-tree.js" type="text/javascript"></script>
    <script src="${V_PATH}/assets/authority/js/resourceManager.js" type="text/javascript"></script>
        ...
        <div class="col-md-12">
            <section class="task-panel tasks-widget">
                <div class="panel-heading">
                    <div class="pull-left"><h5><i class="fa fa-tasks"></i> Resource List</h5></div>
                    <br>
                </div>
                <div class="panel-body">
                    <div class="content" id="content">
                        ...
                        >
                            ...
                            <tr>
                                ...
                                <th data-field="parentname">父目录</th>
                    ...
                    <div class=" add-task-row">
                        <a class="btn btn-success btn-sm pull-right" href="javascript:;" onclick="addResource()">添加资源</a>
                    </div>
                </div>
            </section>
        </div><!--/col-md-12 -->
...
<div id="open-calendar" style="display:none;width: 40%;position: absolute;z-index: 100;top: 20%;left: 30%;">
    ...
    <div class="form-panel">
        <h4 class="mb"><i class="fa fa-angle-right"></i> 添加资源</h4>
        <form class="form-horizontal style-form" method="get">
            ...
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">资源URL</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="url">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">排序编号</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="sortstring">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
				<label class="col-sm-2 col-sm-2 control-label">上级目录</label>
				<div class="col-sm-10">
