...
<head>
    ...
    <script src="${V_PATH}/assets/management/js/roomManager.js" type="text/javascript"></script>
...
<section class="wrapper">
    <h3><i class="fa fa-angle-right"></i> 会议室管理</h3>
    <div class="row mt mb">
        <div class="col-md-12">
            <section class="task-panel tasks-widget">
                ...
                <div class="panel-body">
                    <div class="content" id="content">
                        ...
                        >
                            ...
                            <tr>
                                ...
                                <th data-field="NAME">会议室名称</th>
                                <th data-field="address">地址</th>
                                <th data-field="state">状态(1表示申请,0表示未申请)</th>
                                <th data-field="createdate">创建时间</th>
                                <th data-field="cratename">创建人</th>
                    ...
                    <div class=" add-task-row">
                        <a class="btn btn-success btn-sm pull-right" href="javascript:;" onclick="addUser()">添加会议室</a>
                    </div>
                </div>
            </section>
        </div><!--/col-md-12 -->
...
<div id="open-calendar" style="display:none;width: 40%;position: absolute;z-index: 100;top: 20%;left: 30%;">
    ...
    <div class="form-panel">
        <h4 class="mb"><i class="fa fa-angle-right"></i> 添加会议室</h4>
        <form class="form-horizontal style-form" method="get">
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">会议室名称</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="NAME">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">会议室地址</label>
                <div class="col-sm-10">
