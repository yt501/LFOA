...
<head>
    ...
    <script src="${V_PATH}/assets/publicinfo/js/noticeManger.js" type="text/javascript"></script>
...
<section class="wrapper">
    <h3><i class="fa fa-angle-right"></i> 公告管理</h3>
    <div class="row mt mb">
        <div class="col-md-12">
            <section class="task-panel tasks-widget">
                <div class="panel-heading">
                    <div class="pull-left"><h5><i class="fa fa-tasks"></i> Notice List</h5></div>
                    <br>
                </div>
                <div class="panel-body">
                    ...
                    <div class=" add-task-row">
                        <a class="btn btn-default btn-sm pull-right" href="javascript:;" onclick="addInfo()">添加公告</a>
                    </div>
                </div>
            </section>
        </div><!--/col-md-12 -->
