...
<head>
    ...
    <script src="${V_PATH}/assets/personoffice/js/completask.js" type="text/javascript"></script>
...
<section class="wrapper">
    <h3><i class="fa fa-angle-right"></i> 已完成任务</h3>
    <div class="row mt mb">
        <div class="col-md-12">
            <section class="task-panel tasks-widget">
                ...
                <div class="panel-body">
                    ...
                    <div class=" add-task-row">
                        <a class="btn btn-default btn-sm pull-right" href="javascript:;" onclick="openTask()">跳转到任务</a>
                    </div>
                </div>
            </section>
        </div><!--/col-md-12 -->
